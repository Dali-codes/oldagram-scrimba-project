            ...
            <section class="post-sections">
                <div class="container">  
                    ...
                    <div class="post-content">
                        <div class="icons">
                            <img class="icon-img like-icon" src="images/icon-heart.png" alt="icon of a heart"> 
                            <img class="icon-img" src="images/icon-comment.png" alt="icon to comment on post"> 
                            <img class="icon-img" src="images/icon-dm.png" alt="icon to dm the user">      
                        </div>
